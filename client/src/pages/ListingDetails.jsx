        ...
        <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
                ...
                <div className='flex-1 max-md:w-full'>
                    ...
                    <div className='bg-white rounded-xl border border-gray-200 p-6 mb-5'>
                        ...
                        <div className='flex flex-col md:flex-row md:items-end md:justify-between gap-4'>
                            ...
                            <div>
                                <h2 className='flex items-center gap-2 text-xl font-semibold text-gray-800s'>{listing.title}
                        ...
                        <div className='bg-white rounded-xl border border-gray-200 mb-5 overflow-hidden'>
                            ...
                            <div className='relative w-full aspect-video overflow-hidden'>
                             ...
                             <div className='absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-2'>
                                {images.map((_, index)=>(
                                    <button onClick={()=>setCurrent(index)} key={index} className={`w-2.5 h-2.5 rounded-full ${current===index? "bg-indigo-600" : "bg-gray-300"}`}></button>
                   ...
                   <div className='bg-white rounded-xl border border-gray-200 mb-5'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 p-4 text-sm'>
                            ...
                            <div>
                                ...
                                <p className='font-medium capitalize'>{listing.monetized?"Enabled":"Disabled"}</p>
                            </div>
                            {/* Col-6 */}
                            <div>
            ...
            <div className='bg-white border-t border-gray-200 p-4 text-center mt-20'>
                <p className='text-sm text-gray-500'>
                   Copyright 2025 © <span>Flipearn</span> All Right Reserved.
                </p>
            </div>
        </div>
    ) : (
