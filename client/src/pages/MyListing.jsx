import {
    Plus, Eye, CheckCircle2, TrendingUp, DollarSign,
    WalletIcon, ArrowDownCircleIcon, CoinsIcon,
    StarIcon, LockIcon, Users, CheckCircle,
    BanIcon, XCircle, Clock, TrashIcon,
    Edit, EyeOffIcon, EyeIcon
} from "lucide-react";
...
const MyListing = () => {
    ...
    const getStatusIcon = (status) => {
        switch (status) {
            case "active":
                return <CheckCircle className="size-3.5 text-green-800" />;
            case "ban":
                return <BanIcon className="size-3.5 text-red-800" />;
            case "sold":
                return <DollarSign className="size-3.5 text-indigo-800" />;
            case "inactive":
                return <XCircle className="size-3 text-gray-800" />;
            default:
                return <Clock className="size-3.5 text-gray-800" />;
        }
    };
        ...
        <div className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                ...
                <button
                    ...
                    className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded font-medium flex items-center gap-2 mt-4 md:mt-0"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                ...
                <StatCard title="Active Listings" value={activeListings} icon={<CheckCircle2 className="size-6 text-green-600" />} color="green" />
            ...
            {userListings.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {userListings.map((listing) => (
                        <div key={listing.id} className="bg-white rounded-lg border border-gray-200 hover:shadow-lg transition shadow-gray-200/70">
                            <div className="p-6">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <div className="relative group">
                                                    ...
                                                    <div className="invisible group-hover:visible absolute right-0 top-0 pt-4 z-10">
                                                        <div className="bg-white text-gray-600 text-xs rounded border p-2 px-3">
                                        ...
                                        <div className="flex items-center gap-2">
                                            {listing.status !== "sold" && (
                                                <button
                                                    ...
                                                    className="p-2 border rounded-lg hover:bg-gray-50 hover:text-red-500"
                                                >
                                            ...
                                            <button
                                                ...
                                                className="p-2 border rounded-lg hover:bg-gray-50 hover:text-indigo-500"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="p-2 border rounded-lg hover:bg-gray-50 hover:text-purple-500"
                                            >
                                                {listing.status === "active" ? (
            ...
            {/* Footer */}
            <div className="bg-white border-t border-gray-200 p-4 text-center mt-20">
                <p className="text-sm text-gray-500">
                    © 2025 <span>Flipearn</span> — All Rights Reserved
                </p>
            </div>
        </div>
    );
