...
import { ArrowLeftIcon, FilterIcon, UserSearch } from 'lucide-react';
...
const Marketplace = () => {
    ...
    const filteredListings = listings.filter((listing)=>{
        ...
        if(search){
            ...
            if(!listing.title.toLowerCase().includes(trimed.toLowerCase()) && !listing.username.toLowerCase().includes(trimed.toLowerCase()) && !listing.description.toLowerCase().includes(trimed.toLowerCase()) && !listing.platform.toLowerCase().includes(trimed.toLowerCase()) && !listing.niche.toLowerCase().includes(trimed.toLowerCase()))
        return false;
        }
